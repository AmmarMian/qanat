#!/usr/bin/env python
#
# qanat documentation build configuration file, created by
...
version = qanat.__version__
# The full version, including alpha/beta/rc tags.
release = qanat.__version__
